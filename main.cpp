 ...
 * Class: - 291T (Game Development)
 * Assignment Problem: - Create the SPRIT object and load it to the SCENE using the for loop.
 *
*/
							...
							LPARAM	lParam)			// Additional Message Information
{
    ...
    Scene->WindowMsg(hWnd,uMsg,wParam,lParam);
